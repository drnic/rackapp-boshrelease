...
Vagrant::Config.run do |config|
  ...
  unless File.exist?(local_bosh_src)
    ...
    `cd #{local_bosh_src} && git fetch ssh://$(whoami)@reviews.cloudfoundry.org:29418/bosh refs/changes/26/7126/1 && git cherry-pick FETCH_HEAD`
    `cd #{local_bosh_src} && git fetch ssh://$(whoami)@reviews.cloudfoundry.org:29418/bosh refs/changes/19/7119/1 && git cherry-pick FETCH_HEAD`
